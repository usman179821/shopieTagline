...
class AddProductVC: UIViewController {
    ...
    @IBOutlet weak var productCatgoryTxtField: HoshiTextField!
    ...
    override func viewDidAppear(_ animated: Bool) {
        //        print(catIdDic, "new data get")
        productCatgoryTxtField.text = "\(catIdDic)"
    }
    override func viewDidDisappear(_ animated: Bool) {
        productCatgoryTxtField.resignFirstResponder()
    }
    @IBAction func categoryTextFieldTapped(_ sender: Any) {
        let vc = storyboard?.instantiateViewController(identifier: "productCatgoryMVC") as! productCatgoryMVC
    ...
    @IBAction func addProductTapped(_ sender: Any) {
        ...
        }else if brandNameTextView.text!.isEmpty{
            showSwiftMessageWithParams(theme: .info, title: "Add Product", body: "Please enter product brand ")
            
        }
        else if productCatgoryTxtField.text!.isEmpty {
                ...
                if response.response?.statusCode == 200 {
                    ...
                    do{
                     ...
                     //   print(jsonErr)
                        ...
                        showSwiftMessageWithParams(theme: .info, title: "Add Product", body: jsonErr.localizedDescription)
                    }
